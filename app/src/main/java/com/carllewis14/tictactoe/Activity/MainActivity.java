...
import com.carllewis14.tictactoe.AI.AI;
import com.carllewis14.tictactoe.GameBoard.GameBoard;
...
public class MainActivity extends Activity {
    ...
    public void resetClick(View v) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (Objects.equals(aiMark, "X")) getAIMove(board);
        }
    }
    ...
    public void cellClick(View v) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (Objects.equals(content, "") && !isOver) {
    ...
    /*
      AI Below for AI MOVES and Functionality
     */
